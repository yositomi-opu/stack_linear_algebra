...
[samples/applied-ja](samples/applied-ja/)には、日本語の真偽一対型サンプルを60問収録しています。看護学、民法、経済学基礎、統計リテラシー、研究倫理、情報・AIリテラシーを各10問用意しており、個々のCSVを画面へ読み込んで編集できます。内容と利用上の注意は[サンプル一覧](samples/applied-ja/README.md)を参照してください。
